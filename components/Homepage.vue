        ...
        <div class="container-fluid">
          ...
          <div class="menu-extras topbar-custom">
            <ul class="navigation-menu">
              <li>
                <a href="/Homepage"><i class="mdi mdi-view-dashboard"></i>角色管理</a>
              </li>
              <li>
                <a href="/MyInfo/MyInfo"><i class="mdi mdi-view-dashboard"></i>权限管理</a>
              </li>
              <li class="has-submenu">
                <a href="/Notice"><i class="mdi mdi-view-dashboard"></i>菜单管理</a>
              </li>
              <li class="has-submenu">
                <a href=""><i class="mdi mdi-view-dashboard"></i>用户管理</a>
              </li>
            </ul>
            <!-- Navigation Menu-->
            <!-- End navigation menu -->
